...
set :linked_files, %w{config/database.yml config/database_second.yml config/blazer.yml config/application.yml}
# set :linked_files, %w{config/database.yml}
# set :linked_files, %w{config/database_second.yml}   # what i tried to do but everything is broken...
