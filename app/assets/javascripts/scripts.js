...
function _topNav() {
    ...
    jQuery("#page-menu ul.menu-scrollTo>li").bind("click", function(e) {
        ...
        if (!jQuery("a", this).hasClass("external")) {
            ...
            if (jQuery(_href).length > 0) {
                ...
                jQuery("html,body").animate({ scrollTop: jQuery(_href).offset().top - _padding_top },
                    800,
                    "easeInOutExpo"
                );
            }
    ...
    jQuery("button.btn-mobile").bind("click", function(e) {
        ...
        if (jQuery(this).hasClass("btn-mobile-active")) {
            ...
            if (!jQuery("#topMain").hasClass("nav-onepage") || window.width > 960) {
                /* onepage fix */
                jQuery("html,body").animate({ scrollTop: currentScroll },
                    300,
                    "easeInOutExpo"
                );
            }
...
function _toggle() {
    ...
    jQuery("div.toggle > label").click(function(e) {
        ...
        if (parentSection.hasClass("active")) {
            jQuery(previewPar).animate({ height: previewParAnimateHeight },
                350,
                function() {
            ...
            jQuery(previewPar).animate({ height: previewParClosedHeight },
                350,
                function() {
                            ...
                            _t.validate({
                                submitHandler: function(form) {
                                    ...
                                    jQuery(form).ajaxSubmit({
                                        target: jQuery(form).find(".validate-result").length > 0 ?
...
!(function(e, t, n) {
    ...
    function v(e, t, o, i) {
        ...
        for (
            var f, d, p, m, v, g = ["modernizr", "tspan", "samp"]; !A.style && g.length;
            ...
            function a(e, n, r) {
                ...
                return (
                    (o = r.cache[e] ?
                        ...
                        r.createElem(e)), !o.canHaveChildren || m.test(e) || o.tagUrn ?
                    o :
